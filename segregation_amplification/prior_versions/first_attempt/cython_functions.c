 ...
 */
typedef __pyx_t_5numpy_uint8_t __pyx_t_16cython_functions_DTYPEUINT8_t;
 ...
 */
typedef __pyx_t_5numpy_int_t __pyx_t_16cython_functions_DTYPEINT_t;
 ...
 */
typedef __pyx_t_5numpy_int64_t __pyx_t_16cython_functions_DTYPEINT64_t;
 ...
 * 
 */
typedef __pyx_t_5numpy_float32_t __pyx_t_16cython_functions_DTYPEFLOAT32_t;
 ...
 * 
 */
typedef __pyx_t_5numpy_float64_t __pyx_t_16cython_functions_DTYPEFLOAT64_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
 ...
 * 
 * cdef float[::, ::1] spatial_externality_game(float[::, ::1] direct_benefit, float[::, ::1] social_benefit, float[::, ::1] reciprocal_response):             # <<<<<<<<<<<<<<
 *     cdef long n_rows = direct_benefit.shape[0]
 *     cdef long n_cols = direct_benefit.shape[1]
 */

static __Pyx_memviewslice __pyx_f_16cython_functions_spatial_externality_game(__Pyx_memviewslice __pyx_v_direct_benefit, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_social_benefit, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_reciprocal_response) {
  long __pyx_v_n_rows;
  long __pyx_v_n_cols;
  long __pyx_v_r;
  long __pyx_v_c;
 ...
 *         for c in range(n_cols):             # <<<<<<<<<<<<<<
 * 
 *             output_array[r, c] = direct_benefit[r, c] + direct_benefit[r, c] + direct_benefit[r, c]
 */
 ...
 */
      ...
      *((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_output_array.data + __pyx_t_18 * __pyx_v_output_array.strides[0]) )) + __pyx_t_19)) )) = (((*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_direct_benefit.data + __pyx_t_12 * __pyx_v_direct_benefit.strides[0]) )) + __pyx_t_13)) ))) + (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_direct_benefit.data + __pyx_t_14 * __pyx_v_direct_benefit.strides[0]) )) + __pyx_t_15)) )))) + (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_direct_benefit.data + __pyx_t_16 * __pyx_v_direct_benefit.strides[0]) )) + __pyx_t_17)) ))));
    }
  }
 ...
 * 
 */
  __PYX_INC_MEMVIEW(&__pyx_v_output_array, 0);
 ...
 */
  ...
  __Pyx_AddTraceback("cython_functions.spatial_externality_game", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
